<?php
// source: C:\laragon\www\moje-admin/config/common.neon
// source: C:\laragon\www\moje-admin/config/services.neon
// source: C:\laragon\www\moje-admin/config/local.neon
// source: array
...
class Container_5de31de088 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presentation\Sign\SignPresenter' => [2 => ['application.4']],
	...
	public function createServiceApplication__4(): App\Presentation\Sign\SignPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\laragon\www\moje-admin/temp/cache/nette.application/touch',
		));
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('C:\laragon\www\moje-admin\www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\laragon\www\moje-admin/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\laragon\www\moje-admin/temp/cache', $this->getService('cache.journal'));
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=admin_db', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_5de31de088 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\laragon\www\moje-admin/temp/cache/latte');
